...
namespace Common.Data.Migrations
{
    ...
    [Migration("20260520153106_FixTriageParametersIdentityMapping")]
    partial class FixTriageParametersIdentityMapping
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Common.Data.Entity.Allergy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Common.Data.Entity.MedicalRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Common.Data.Entity.Patient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Common.Data.Entity.PatientAllergy", b =>
                {
            ...
            modelBuilder.Entity("Common.Data.Entity.Prescription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Common.Data.Entity.PrescriptionItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Common.Data.Entity.Transplant", b =>
                {
                    b.Property<int>("TransplantId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Common.Data.Entity.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Common.Data.Models.ER_Room", b =>
                {
            ...
            modelBuilder.Entity("Common.Data.Models.ER_Visit", b =>
                {
            ...
            modelBuilder.Entity("Common.Data.Models.Examination", b =>
                {
            ...
            modelBuilder.Entity("Common.Data.Models.Transfer_Log", b =>
                {
            ...
            modelBuilder.Entity("Common.Data.Models.Triage", b =>
                {
            ...
            modelBuilder.Entity("Common.Data.Entity.MedicalHistory", b =>
                {
                    b.HasOne("Common.Data.Entity.Patient", "Patient")
                        ...
                        .HasForeignKey("Common.Data.Entity.MedicalHistory", "PatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Common.Data.Entity.MedicalRecord", b =>
                {
                    b.HasOne("Common.Data.Entity.MedicalHistory", "History")
            ...
            modelBuilder.Entity("Common.Data.Entity.PatientAllergy", b =>
                {
                    b.HasOne("Common.Data.Entity.Allergy", "Allergy")
                        .WithMany()
                        .HasForeignKey("AllergyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Common.Data.Entity.MedicalHistory", "MedicalHistory")
            ...
            modelBuilder.Entity("Common.Data.Entity.Prescription", b =>
                {
                    b.HasOne("Common.Data.Entity.MedicalRecord", "MedicalRecord")
                        .WithOne("Prescription")
                        .HasForeignKey("Common.Data.Entity.Prescription", "RecordId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Common.Data.Entity.PrescriptionItem", b =>
                {
                    b.HasOne("Common.Data.Entity.Prescription", "Prescription")
